...
func (m Model) View() string {
	...
	keyHelp := "↑/↓: select • enter: detail • f: filters • s: status • l: lead • p: priority • n: next action • k: link • m: merge • q: quit"
	switch m.currentView {
	case ViewLeadSelector:
		keyHelp = "type: search leads • ↑/↓: select • enter: apply • esc: cancel • ctrl+c: quit"
	case ViewDetail:
